...
Begin VB.Form driver 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(4)=   "Drive1"
      Tab(1).Control(5)=   "List5"
      ...
      Begin VB.Label Label6 
         ...
         Caption         =   "WILL BE ADDED MORE INFO AND WILL ON PSC  SOON"
         Height          =   585
         Left            =   1140
         TabIndex        =   15
         Top             =   5295
      ...
      Begin VB.Label Label5 
         Alignment       =   2  'Center
         BackStyle       =   0  'Transparent
         Caption         =   "WINDOWS VERSIYONU VE ORTAMI"
         Height          =   270
         Left            =   195
         TabIndex        =   14
         Top             =   2280
...
List2.AddItem ("Boyutlandirilmayan Pencerelerin Yatay Kenarlik Kalinligi:  " & GetSystemMetrics(5))
List2.AddItem ("Boyutlandirilmayan Pencerelerin Dikey Kenarlik Kalinligi:  " & GetSystemMetrics(6))
